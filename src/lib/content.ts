...
members: [
  ...
  contactModal: {
    ...
    description: {
      en: "Send us a message or schedule a free 30-minute discovery call.",
      es: "Envíanos un mensaje o agenda una llamada gratuita de descubrimiento de 30 minutos.",
    },
    tabMessage: { en: "Send a Message", es: "Enviar Mensaje" },
    tabSchedule: { en: "Schedule a Call", es: "Agendar Llamada" },
    // Shared fields
    ...
    companyPlaceholder: { en: "Your company", es: "Tu empresa" },
    companyRequired: { en: "Company is required", es: "La empresa es obligatoria" },
    ...
    // Schedule tab
    pickDate: { en: "Pick a date", es: "Elige una fecha" },
    pickTime: { en: "Select a time", es: "Selecciona una hora" },
    morning: { en: "Morning", es: "Mañana" },
    afternoon: { en: "Afternoon", es: "Tarde" },
    scheduleBtn: { en: "Schedule Call", es: "Agendar Llamada" },
    scheduling: { en: "Scheduling…", es: "Agendando…" },
    successTitle: { en: "You're all set!", es: "¡Listo!" },
    successMessage: {
      en: "Your discovery call has been scheduled. Check your email for the calendar invitation.",
      es: "Tu llamada de descubrimiento ha sido agendada. Revisa tu correo para la invitación del calendario.",
    },
    errorSlotTaken: {
      en: "This time slot is no longer available. Please choose another.",
    ...
    // Step indicator
    stepDateLabel: { en: "Date", es: "Fecha" },
    stepDateDesc: { en: "When works best for you?", es: "¿Cuándo te viene mejor?" },
    stepTimeLabel: { en: "Time", es: "Hora" },
    stepTimeDesc: { en: "Morning or afternoon?", es: "¿Mañana o tarde?" },
    stepDetailsLabel: { en: "Details", es: "Datos" },
    stepDetailsDesc: { en: "Almost there! Tell us about you", es: "¡Casi listo! Cuéntanos de ti" },
    formProgress: { en: "Form progress", es: "Progreso del formulario" },
    // Misc UI
    closeBtn: { en: "Close", es: "Cerrar" },
    backToDate: { en: "Go back to date selection", es: "Volver a seleccionar fecha" },
    backToTime: { en: "Go back to time selection", es: "Volver a seleccionar hora" },
    bookingConfirmed: { en: "Booking confirmed", es: "Reserva confirmada" },
    loadingAvailability: { en: "Checking availability\u2026", es: "Verificando disponibilidad\u2026" },
    noSlots: { en: "No available slots for this date. Please choose another day.", es: "No hay horarios disponibles para esta fecha. Por favor elige otro d\u00eda." },
    privacyRequired: { en: "You must accept the privacy policy", es: "Debes aceptar la política de privacidad" },
    privacyPrefix: { en: "I agree to the ", es: "Acepto la " },
    privacyLink: { en: "privacy policy", es: "política de privacidad" },
    privacySuffix: {
      en: ". Your data is used solely to respond to your inquiry.",
      es: ". Tus datos se usan únicamente para responder tu consulta.",
    },
  },
  ctaSection: {
